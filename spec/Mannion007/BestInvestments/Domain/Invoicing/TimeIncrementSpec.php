...
class TimeIncrementSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith(-1);
        $this->shouldThrow(new \Exception('A Time Increment must have a positive number of minutes'))
            ->duringInstantiation();
    }
    ...
    function it_initialises_with_zero_minutes()
    {
        ...
        $this->shouldNotThrow(new \Exception('A Time Increment must have a positive number of minutes'))
            ->duringInstantiation();
    }
